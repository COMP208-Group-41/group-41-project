...
<div class="slideshow-container">
    <div class="mySlides fade">
        ...
        <img src="https://student.csc.liv.ac.uk/~sgstribe/Images/Venue/3/6/venue.jpg" onclick="location.href='venue.php?venueID=6'" alt="Venue Image" class="title-img">
        <div class="text">Rock Bar</div>
    </div>

    <div class="mySlides fade">
        <div class="numbertext">2 / 3</div>
        <img src="https://student.csc.liv.ac.uk/~sgstribe/Images/Venue/2/3/venue.jpg" onclick="location.href='venue.php?venueID=3'" alt="Venue Image" class="title-img">
